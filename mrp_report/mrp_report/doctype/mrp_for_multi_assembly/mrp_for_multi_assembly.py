...
class MRPforMultiAssembly(Document):
	...
	def download_file(self):
		data = frappe.get_all("Child MRP for Multi Assembly", 	
									...
									fields=["productionplan","prodplanwarehouse","itemcode","itemname","supplier","requiredbomqty","actualqty",
"virtual_warehouse","alloted_qty","material_to_request","materialrequestedqty","materialorderedqty","materialreceivedqty",
"material_ordered_but_pending_to_receive_qty","material_to_order"])
		...
		with open(file_path, 'w', newline='') as csvfile:
			fieldnames = ["productionplan","prodplanwarehouse","itemcode","itemname","supplier","requiredbomqty","actualqty",
"virtual_warehouse","alloted_qty","material_to_request","materialrequestedqty","materialorderedqty","materialreceivedqty",
"material_ordered_but_pending_to_receive_qty","material_to_order"]  # Replace with your actual field names
